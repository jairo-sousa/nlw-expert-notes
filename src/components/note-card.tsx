        ...
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="overflow-hidden fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
                    <Dialog.DialogClose className="absolute right-0 top-0 bg bg-slate-800 p-1.5 text-slate-400 hover:text-slate-100">
                        <X className="size-5" />
                    </Dialog.DialogClose>
                    ...
                    <button
                        type="button"
                        className="w-full bg bg-slate-800 py-4 text-center text-sm text-slate-300 outline-none font font-medium group">
                        Deseja{" "}
